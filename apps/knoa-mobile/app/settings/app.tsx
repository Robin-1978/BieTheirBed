...
const styles = StyleSheet.create({
  ...
  updateText: { color: colors.onAccent, fontWeight: "700" },
  updateHint: { color: colors.muted, ...typography.small, lineHeight: 18 },
  enabled: { color: colors.accent, fontWeight: "700" },
  disabled: { color: colors.warning, fontWeight: "700" },
  ...
  settingsButtonText: { color: colors.accent, fontWeight: "700" },
