...
Defines the pc-assistant-system capability and its required behavior.

## Requirements

### Requirement: Interaction surfaces SHALL use CoreServer as the only execution authority
@id: pc-assistant.entry.streaming-execution
...
@id: pc-assistant.session.isolation
...
@id: pc-assistant.context.integrity
...
@id: pc-assistant.provider.neutral-ir
...
@id: pc-assistant.safety.authorize-before-execute
...
@id: pc-assistant.tools.schema-and-results
...
@id: pc-assistant.runtime.observability
...
@id: pc-assistant.quality.verification
