"""Transport for listing and downloading files from public OSS buckets.

Copied from the Jira reference server's oss_downloader transport layer so this
package stays independently deployable. Text-link extraction (extract_oss_links)
stays in the Jira package because it parses Jira issue text.
"""
