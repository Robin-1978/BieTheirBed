...
def _patch_ws_card_dispatch(ws_client: Any) -> None:
    ...
    if getattr(ws_client, "_knoa_platform_card_dispatch_patched", False):
        return
    try:
        import http
        import types
        ...
        ws_client._knoa_platform_card_dispatch_patched = True
