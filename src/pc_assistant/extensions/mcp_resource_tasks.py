...
from pc_assistant.extensions.models import MCPResourceTaskConfig
from pc_assistant.tasks import TaskIdempotencyConflictError, TaskOrigin
    ...
    async def _create_task(
        ...
        try:
            await self._tasks.create(
                scope,
                client_request_id=_task_request_id(server_id, uri),
                goal=goal,
