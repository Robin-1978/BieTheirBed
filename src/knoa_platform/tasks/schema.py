        ...
        with self._connect() as db:
            ...
            require_exact_table(
                ...
                (
                    ...
                    ("tools_enabled", "INTEGER", True, None, 0),
                    ("priority", "INTEGER", True, None, 0),
                    ("notification_policy_json", "TEXT", True, None, 0),
                    ("state", "TEXT", True, None, 0),
                    ("revision", "INTEGER", True, None, 0),
                    ("latest_execution_id", "TEXT", False, None, 0),
                    ("created_at", "REAL", True, None, 0),
                    ("updated_at", "REAL", True, None, 0),
                ),
            ...
            require_exact_table(
                ...
                "task_executions",
                (
                    ("execution_id", "TEXT", False, None, 1),
                    ("task_id", "TEXT", True, None, 0),
                    ("task_revision", "INTEGER", True, None, 0),
                    ("agent_id_snapshot", "TEXT", True, None, 0),
                    ("launch_reason", "TEXT", True, None, 0),
                    ("goal_snapshot", "TEXT", True, None, 0),
                    ("attachments_json", "TEXT", True, None, 0),
                    ("policy_snapshot_json", "TEXT", True, None, 0),
                    ("created_at", "REAL", True, None, 0),
                ),
