...
from knoa_platform.tasks.definition_repository import TaskDefinitionRepositoryMixin
from knoa_platform.tasks.errors import (
    TaskNotFoundError,
)
from knoa_platform.tasks.execution_repository import TaskExecutionRepositoryMixin
...
from knoa_platform.tasks.runtime_repository import TaskRuntimeRepositoryMixin
from knoa_platform.tasks.schema import TaskSchemaMixin
from knoa_platform.tasks.tool_repository import TaskToolRepositoryMixin
...
class TaskRepository(
    ...
    def _execution_record(
        ...
        *,
        ...
        return TaskExecutionRecord(
            ...
            agent_id_snapshot=str(mapping["agent_id_snapshot"]),
    ...
    @staticmethod
    def _owned_session(db: sqlite3.Connection, scope: RuntimeScope) -> sqlite3.Row:
        row = db.execute(
