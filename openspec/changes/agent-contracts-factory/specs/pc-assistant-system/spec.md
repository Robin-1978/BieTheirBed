...
@id: pc-assistant.runtime.event-separation
...
@id: pc-assistant.runtime.factory-owner
...
@id: pc-assistant.runtime.atomic-model-rebuild
...
@id: pc-assistant.runtime.canonical-exports

- [REQ-005] The `pc_assistant.agent_runtime` package SHALL expose the approved runtime contracts and factory using canonical names and SHALL NOT export `AgentLike`, `ServiceClient`, `AgentEvent`, `RuntimeControl`, `TurnOrchestrator`, or an `Agent = AgentRuntime` alias.
