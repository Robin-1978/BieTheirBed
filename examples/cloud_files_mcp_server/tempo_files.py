"""Transport for listing and downloading shared robot records from Tempo.

Copied from the Jira reference server's tempo_downloader transport layer so this
package stays independently deployable. Share-link extraction
(extract_tempo_share_links) stays in the Jira package because it parses Jira
issue text.
"""
